        ...
        <div class="panel-heading"><h3><span class="glyphicon glyphicon-list-alt"></span> <?php echo $pluralHumanName; ?>
                <div class="btn-group pull-right">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li>   
                            <?php echo $this->Html->link(__d('cake', '<span class="glyphicon glyphicon-plus-sign"></span> Create %s', $singularHumanName), array('action' => 'add'), array('escape' => false, 'data-toggle'=>"ajaxModal")); ?>
                        </li>
                        <?php
                        $done = array();
                        foreach ($associations as $_type => $_data) {
                            foreach ($_data as $_alias => $_details) {
                                if ($_details['controller'] != $this->name && !in_array($_details['controller'], $done)) {
                                    ...
                                    echo '<li>';
                                    echo $this->Html->link(
                                            __d('cake', '<span class="glyphicon glyphicon-plus-sign"></span> Create %s', Inflector::humanize(Inflector::underscore($_alias))), array('plugin' => $_details['plugin'], 'controller' => $_details['controller'], 'action' => 'add'), array('escape' => false, 'data-toggle'=>"ajaxModal")
                                    );
                                    echo '</li>';
            ...
            <table class="table table-bordered table-hover table-condensed" >
                ...
                <tbody>
                    ...
                    foreach (${$pluralVar} as ${$singularVar}):
                        ...
                        echo ' ' . $this->Html->link('<span class="glyphicon glyphicon-pencil"><span>', array('action' => 'edit', ${$singularVar}[$modelClass][$primaryKey]), array('escape' => false, 'class' => 'btn btn-default btn-xs', 'data-toggle'='ajaxModal'));
